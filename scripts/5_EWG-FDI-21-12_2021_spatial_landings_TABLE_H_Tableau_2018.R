...
fdi.tableau <- fdi.tableau[year==2018,]
...
fwrite(resultEU28DT, 'spatial_landings_tableau_pts_2018_EU28.csv')
resultEU28DT <- NULL;
...
fwrite(resultEU27DT, 'spatial_landings_tableau_pts_2018_EU27.csv')
resultEU27DT <- NULL;
load(file='../csquares/grids.RData')
