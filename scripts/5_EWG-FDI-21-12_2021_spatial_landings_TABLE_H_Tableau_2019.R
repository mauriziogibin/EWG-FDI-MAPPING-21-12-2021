...
fdi.tableau <- fdi.tableau[year==2019,]
...
fwrite(resultEU28DT, 'spatial_landings_tableau_pts_2019_EU28.csv')
resultEU28DT <- NULL;
...
# # For some reason year 2019 has a feature with an error, feature 676321.
# resultEU28_sf_2019 <- resultEU28_sf[resultEU28_sf$year ==2019,]
# resultEU28_sf_2019 <- resultEU28_sf[resultEU28_sf$year ==2019,]
# resultEU28_sf[resultEU28_sf$year ==2019,] <- NULL;gc()
# resultEU28_sf_2019 <- resultEU28_sf[resultEU28_sf$year ==2019,]
# resultEU28_sf[resultEU28_sf$year ==2019,] <- NULL;gc()
# resultEU28_sf_2019 <- resultEU28_sf[resultEU28_sf$year ==2019,]
# resultEU28_sf[resultEU28_sf$year ==2019,] <- NULL;gc()
...
# plot(resultEU28_sf_2019[676321,])
# st_is_valid(resultEU28_sf_2019[676321,])
...
fwrite(resultEU27DT, 'spatial_landings_tableau_pts_2019_EU27.csv')
resultEU27DT <- NULL;
load(file='../csquares/grids.RData')
...
# # For some reason year 2019 has a feature with an error, fearutre 676321.
# resultEU27_sf_2019 <- resultEU27_sf[resultEU27_sf$year ==2019,]
# resultEU27_sf_2019 <- resultEU27_sf[resultEU27_sf$year ==2019,]
# resultEU27_sf[resultEU27_sf$year ==2019,] <- NULL;gc()
# resultEU27_sf_2019 <- resultEU27_sf[resultEU27_sf$year ==2019,]
# resultEU27_sf[resultEU27_sf$year ==2019,] <- NULL;gc()
# resultEU27_sf_2019 <- resultEU27_sf[resultEU27_sf$year ==2019,]
# resultEU27_sf[resultEU27_sf$year ==2019,] <- NULL;gc()
...
# # plot(resultEU27_sf_2019[676321,])
# # st_is_valid(resultEU27_sf_2019[676321,])
