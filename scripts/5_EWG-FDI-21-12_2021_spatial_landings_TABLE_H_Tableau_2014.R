...
fwrite(resultEU28DT, 'spatial_landings_tableau_pts_2014_EU28.csv')
resultEU28DT <- NULL;
...
# resultEU28_sf_2014 <- resultEU28_sf[resultEU28_sf$year ==2014,]
# resultEU28_sf[resultEU28_sf$year ==2014,] <- NULL;gc()
...
fwrite(resultEU27DT, 'spatial_landings_tableau_pts_2014_EU27.csv')
resultEU27DT <- NULL;
load(file='../csquares/grids.RData')
...
# resultEU27_sf_2014 <- resultEU27_sf[resultEU27_sf$year ==2014,]
# resultEU27_sf[resultEU27_sf$year ==2014,] <- NULL;gc()
