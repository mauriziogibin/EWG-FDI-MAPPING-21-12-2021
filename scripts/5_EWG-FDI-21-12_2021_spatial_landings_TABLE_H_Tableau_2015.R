...
fdi.tableau <- fdi.tableau[year==2015,]
...
fwrite(resultEU28DT, 'spatial_landings_tableau_pts_2015_EU28.csv')
resultEU28DT <- NULL;
...
fwrite(resultEU27DT, 'spatial_landings_tableau_pts_2015_EU27.csv')
resultEU27DT <- NULL;
load(file='../csquares/grids.RData')
